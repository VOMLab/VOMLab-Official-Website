...
const Contact = () => {
  return <main className="flex flex-col h-screen">
        ...
        <section className="flex-1 mt-10 pr-5 pl-5 grid grid-template-rows" style={{gridTemplateRows: '30% 20% 40%'}}>
            ...
            <div className="grid-row-3 flex flex-col justify-around">
                <div>
                    <p className='mb-5'><strong>SERVICES.</strong></p>
                ...
                <div>
                    <p className='mb-5'><strong>CONTACT.</strong></p>
                    <div className='font-light'>
                        <p>02-6506-0318</p>
                        <p>INFO@VOMLAB.COM</p>
                    </div>
                ...
                <div>
                    <p className='mb-5'><strong>ADDRESS.</strong></p>
